...
class Text(commands.Cog):
    ...
    async def space(self, ctx):
        ...
        google = ImageSearch()
        print("Using image \'{}\'".format(query))
        image = google.search(query)
        print("Embedding image \'{}\'".format(image))
        if image == None:
            await ctx.send("**Error**: Cannot get image...")
            return
    ...
    async def info(self, ctx):
        embed = discord.Embed(description="Little bot for adding voice roles, by http://donald108.com/", colour=0x5C77FF)
        embed.set_author(name="Voice Bot", url="http://astrosoc.club", icon_url="https://avatars3.githubusercontent.com/u/26580217?s=460&u=2b5115f75c19140924f46b314f762d14de398d35&v=4")
